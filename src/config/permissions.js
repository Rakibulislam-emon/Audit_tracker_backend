...
export const PERMISSIONS = {
  ...
  // Check Types
  CHECK_TYPE: {
    VIEW: [ROLES.ADMIN, ROLES.MANAGER, ROLES.AUDITOR],
    CREATE: [ROLES.ADMIN],
    UPDATE: [ROLES.ADMIN],
    DELETE: [ROLES.ADMIN],
  },
  ...
  // Question Rule Links
  QUESTION_RULE_LINK: {
    VIEW: [ROLES.SYSADMIN, ROLES.ADMIN, ROLES.COMPLIANCE_OFFICER],
    CREATE: [ROLES.SYSADMIN, ROLES.ADMIN, ROLES.COMPLIANCE_OFFICER],
